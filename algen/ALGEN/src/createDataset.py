...
if __name__ == '__main__':
    ...
    texts = [
        ...
        "Коментарии можно сохранять!?? охренеть, спасибо чувак\nСпасибо что сказал что кмменты можно сохранять, сохранил. Пригодиться!\nЧто сделаЕТ? ПригодиТСЯ ...\nя двоечник :. ",
    ]
    ...
    dataset = InversionDataset(texts, tokenizer, "ru", encoder, device, 32)
